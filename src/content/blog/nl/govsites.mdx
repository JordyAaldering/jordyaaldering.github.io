...
import strategies_nl from '../../../assets/govsites/strategies_nl.png'
...
In de praktijk blijven veel bezoekers maar kort op de homepagina en klikken ze snel door naar de informatie of dienst die ze zoeken.
Zware media-elementen voegen op deze pagina daarom vaak weinig waarde toe, maar zorgen wel bij elk bezoek voor extra energieverbruik.
In veel gevallen is een eenvoudige en lichte homepagina dan ook de beste keuze.
...
<Expandable title="Hoe hebben we dit berekend?">
  TODO
</Expandable>
...
<p align="center">
  <Image src={strategies_nl} alt="Strategies" style="width: 100%; height: auto" />
</p>
